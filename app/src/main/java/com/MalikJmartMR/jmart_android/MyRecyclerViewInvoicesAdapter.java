...
public class MyRecyclerViewInvoicesAdapter extends RecyclerView.Adapter<MyRecyclerViewInvoicesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.img_productInvoice.setImageResource(ProductDetailActivity.getDrawableId(productName.category.toString()));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ViewHolder(View itemView) {
            ...
            img_productInvoice = itemView.findViewById(R.id.rv_image_productInvoice);
            ...
            btnAcceptInvoice.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View v) {
                    StringRequest cancelRequest = new StringRequest(Request.Method.POST, "http://10.0.2.2:8069/payment/"+id+"/accept", new Response.Listener<String>() {
                        @Override
            ...
            btnCancelTransaction.setOnClickListener(new View.OnClickListener(){
                @Override
                public void onClick(View v) {
                    StringRequest cancelRequest = new StringRequest(Request.Method.POST, "http://10.0.2.2:8069/payment/"+id+"/cancel", new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {
                            try {
            ...
            btnSubmitTransaction.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View v) {
                    ...
                    StringRequest cancelRequest = new StringRequest(Request.Method.POST, "http://10.0.2.2:8069/payment/"+id+"/submit?receipt="+receiptText, new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {
                            try {
