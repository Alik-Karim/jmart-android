...
public class MyRecyclerViewTransactionsAdapter extends RecyclerView.Adapter<MyRecyclerViewTransactionsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.productInvoiceTransaction_img.setImageResource(ProductDetailActivity.getDrawableId(productName.category.toString()));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ViewHolder(View itemView) {
            ...
            productInvoiceTransaction_img = itemView.findViewById(R.id.rv_image_productInvoiceT);
