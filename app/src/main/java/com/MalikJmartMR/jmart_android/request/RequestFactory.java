package com.MalikJmartMR.jmart_android.request;
...
public class RequestFactory {
    private static final String URL_FORMAT_ID = "http://10.0.2.2:8069/%s/%d";
    private static final String URL_FORMAT_PAGE = "http://10.0.2.2:8069/%s/page?page=%s&pageSize=&s";
